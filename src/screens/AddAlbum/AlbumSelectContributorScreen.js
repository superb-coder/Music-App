...
class AlbumSelectContributorScreen extends React.Component {
	...
	clickBackButton = () => {
		...
		global.refreshEmitter.emit("ALBUM_ADD_CONTRIBUTORS", { data: data });
...
export default AlbumSelectContributorScreen;
