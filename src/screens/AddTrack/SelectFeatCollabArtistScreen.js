...
class SelectFeatCollabArtistScreen extends React.Component {
	...
	clickBackButton = () => {
		...
		global.refreshEmitter.emit("ADD_FEAT_COLLAB", { data: data });
...
export default SelectFeatCollabArtistScreen;
